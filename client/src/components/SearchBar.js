...
const SearchBar = () => {
  return (
    <div className="sticky-container">
      <div className="sticky top-0 z-50 border-t-2 border-t-primary bg-white p-2 border-b border-gray-300 overscroll-none">
        <div className="flex justify-between items-center container">
          ...
          {/* User Actions */}
          <div className="flex items-center space-x-2 px-4">
            <button className="px-3 py-1 bg-white text-blue-500 border border-blue-500 rounded-md hover:bg-blue-100">Log in</button>
            <button className="px-3 py-1 bg-blue-500 text-white rounded-md hover:bg-blue-600">Sign up</button>
          </div>
        </div>
      </div>
    </div>
